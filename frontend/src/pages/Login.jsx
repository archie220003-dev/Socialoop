...
import { Eye, EyeOff, Loader2, Sun, Moon, Monitor, ChevronDown } from 'lucide-react';
            ...
            <div style={{ width: '100%', transform: 'translateZ(30px)' }}>
              ...
              <div className="staggered-item" style={{ animationDelay: '0.5s', marginTop: '24px' }}>
                <p style={{ fontSize: '15px', color: 'var(--text-muted)', fontWeight: 500 }}>
                  Don't have an account? <Link to="/register" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 700, marginLeft: '4px' }}>Sign up</Link>
                </p>
              </div>
            </div>
          </div>
