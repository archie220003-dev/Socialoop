            ...
            {trending.map((post, idx) => (
              <div
                ...
                style={{
                  ...
                  backgroundImage: post.image ? `linear-gradient(to top, rgba(0,0,0,0.8), rgba(0,0,0,0.2)), url(${post.image})` : 'linear-gradient(135deg, rgba(var(--primary-rgb), 0.8), rgba(90, 200, 250, 0.8))',
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '8px' }}>
                  <div style={{ width: '16px', height: '16px', borderRadius: '50%', background: post.author?.avatar ? `url(${post.author.avatar}) center/cover` : 'var(--primary)' }}></div>
