...
const About = () => {
  ...
  return (
    <div className="about-page-container animate-in" style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <section className="glass staggered-item" style={{ padding: '40px', textAlign: 'center', animationDelay: '0.4s', marginBottom: '40px' }}>
        <h2 style={{ marginBottom: '20px', fontSize: '28px' }}>About the Creator</h2>
        <div style={{ textAlign: 'left', background: 'rgba(var(--text-main-rgb), 0.03)', padding: '24px', borderRadius: '12px', borderLeft: '4px solid var(--primary)' }}>
          <p style={{ fontStyle: 'italic', color: 'var(--text-main)', fontSize: '18px', lineHeight: '1.8', textAlign: 'center' }}>
            "Crafted by a sleep-deprived student building projects for his resume. 10% code, 90% hope, and just enough caffeine to keep the servers running. If you're a recruiter, please look at the code before the bugs look at you."
          </p>
        </div>
      </section>

      {/* The "Strictly Professional" Statement */}
      <section className="glass staggered-item" style={{ padding: '40px', textAlign: 'center', animationDelay: '0.5s' }}>
